	...
	if(isset($_POST['btn2'])){
		...
		if ($run_sql = mysqli_query($conn, $sel_sql)){
			if (mysqli_num_rows($run_sql) == 1){
				...
				header ('Location: subscriber/offer.php');
			}
		}
	}else{
					...
					<div class="col-sm-12-fluid">
						<img class="mainImage" alt="" src="images/dog2.jpg">
							<form class="form" action="search.php" method="post" role="form">	
								<button type="submit" id="btn1" class="btn btn-lg btn-light text-dark"><i class="fa fa-map-marker"></i>&nbsp Search for a job!
								</button>
							</form>
				...
				<div class="row">
					...
					<div class="col-sm-6" style="padding-top: 50px;">
						<form class="form" action="index.php" method="post" role="form">
							<button type="submit" name="btn2" id="btn2" class="btn btn-lg btn-light text-dark"><i class="fa fa-map-marker"></i>&nbsp Offer a job!
							</button>
						</form>
